**WARNING**: Despite polished appearance, this repository is work in progress pending review and refinement of the content generated by the coding agent. The source queries were written manually, but were not yet confirmed to be correct after being transferred from the source Google Doc [IDC BigQuery Cookbook](https://docs.google.com/document/d/1qC5_qUFBQ2HmEjfYQa9WaH1Y-erMlfis00bbU8UPnRs/edit?tab=t.0). 
